...
user_string_def platform_strings[] = {
	...
	{STR_SHEEP_MEM_MMAP_ERR, "Cannot map SheepShear Data area: %s."},
	...
	{STR_PREFS_ITEM_START_GTK, "/File/_Start SheepShear"},
	{STR_PREFS_ITEM_ZAP_PRAM_GTK, "/File/_Zap PRAM File"},
	{STR_PREFS_ITEM_SEPL_GTK, "/File/sepl"},
	{STR_PREFS_ITEM_QUIT_GTK, "/File/_Quit SheepShear"},
	{STR_HELP_MENU_GTK, "/_Help"},
	{STR_HELP_ITEM_ABOUT_GTK, "/Help/_About SheepShear"},
	...
	{STR_SUSPEND_WINDOW_TITLE, "SheepShear suspended. Press Space to reactivate."},
	{STR_VOSF_INIT_ERR, "Cannot initialize Video on SEGV signals."},

	{STR_OPEN_WINDOW_ERR, "Cannot open Mac window."},
	{STR_WINDOW_TITLE_GRABBED, "SheepShear (mouse grabbed, press Ctrl-F5 to release)"},
